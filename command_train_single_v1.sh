CUDA_VISIBLE_DEVICES=1,0 accelerate launch train_single_v1.py \
 ...
 --validation_image="/data/muxiangyu/pythonPrograms/StableAnimator/validation/centered_heads_v5/frame_1.png" \
 --validation_cloth_image="/data/muxiangyu/pythonPrograms/StableAnimator/validation/clothes_white_complete_v5/frame_1.png" \
 --validation_face_pose='/data/muxiangyu/pythonPrograms/StableAnimator/validation/pose_head_new_v5/frame_1.png' \
 --num_workers=1 \
 --lr_warmup_steps=500 \
 --sample_n_frames=8 \
 --learning_rate=1e-5 \
